...
if ENV:
    class Config(object):
        ...
        PRIVATE_GROUP_BOT_API_ID = int(os.environ.get("PRIVATE_GROUP_BOT_API_ID", --1001369346613))
        # Send .get_id in any channel to fill this value. ReQuired for @Manuel15 inspiration to work!
        PRIVATE_CHANNEL_BOT_API_ID = int(os.environ.get("PRIVATE_CHANNEL_BOT_API_ID", --1001369346613))
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "sparkzzz")
        # For Command Handler
        ...
        G_BAN_LOGGER_GROUP = int(os.environ.get("G_BAN_LOGGER_GROUP",-1001369346613 ))
        ...
        OFFICIAL_UPSTREAM_REPO = os.environ.get("OFFICIAL_UPSTREAM_REPO", "https://github.com/vishnu175/SPARKZZZ")
        ...
        # REPO
        UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/vishnu175/SPARKZZZ")
